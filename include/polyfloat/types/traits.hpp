...
namespace plf
{
  ...
  //!
  //! If `T` satisfies plf::concepts::polyfloat, evaluates to the number of dimension of the smallest
  //! poly-float in which any instance of `T` can be represented.
  //!
  ...
  //!
  //! @tparam Dim Dimension of the Poly-Float algebra to use.
...
namespace plf
{
  ...
  //====================================================================================================================
  //! @brief Compute the polyfloat_like type associated to a Poly-Float-like family of types
  //!
