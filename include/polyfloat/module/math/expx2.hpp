...
namespace plf::_
{
  template<typename T, eve::callable_options O> constexpr auto expx2_(POLYFLOAT_DELAY(), O const& o, T a0) noexcept
  {
    ...
    else //return eve::exp[o](plf::sqr(a0));
    {
      ...
      else
      {
        ...
        u_t const Expx2c1 = eve::ieee_constant<0x1.0000000000000p+7, 0x1.0p+5f>(eve::as<u_t>{});
        u_t const Expx2c2 = eve::ieee_constant<0x1.0000000000000p-7, 0x1.0p-5f>(eve::as<u_t>{});
