...
namespace plf
{
  ...
  template<typename Options> struct negabsmax_t : eve::strict_tuple_callable<negabsmax_t, Options, raw_option, pedantic_option>
  {
...
namespace plf::_
{
  ...
  POLYFLOAT_FORCEINLINE constexpr auto negabsmax_(POLYFLOAT_DELAY(), O const& o,
