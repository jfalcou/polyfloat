...
namespace plf
{
  ...
  struct negabsmin_t : eve::strict_tuple_callable<negabsmin_t, Options, raw_option, pedantic_option>
  {
    ...
    POLYFLOAT_CALLABLE_OBJECT(negabsmin_t, negabsmin_);
  };
  //======================================================================================================================
  //! @addtogroup core
  //! @{
  //!   @var negabsmin
  //!   @brief return the opposite of the absolute value of the minimum of the parameters.
  //!
  ...
  //!   namespace polyfloat
  //!   {
  //!      template<polyfloat::concepts::polyfloat_like Z1, polyfloat_like Z2> constexpr auto negabsmin(Z1 z1, Z2 z2) noexcept;
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
  ...
  //!   **Return value**
  //!
  //!      Returns the opposite of the absolute value of the minimum of the arguments.
  //!
  //!  @groupheader{Example}
  //!
