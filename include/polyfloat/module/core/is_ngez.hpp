...
namespace plf
{
  ...
  struct is_ngez_t : eve::elementwise_callable<is_ngez_t, Options, raw_option, pedantic_option>
  {
  ...
  //!   namespace polyfloat
  //!   {
  //!      template<polyfloat::concepts::polyfloat_like T> constexpr auto is_ngez(T z) noexcept;
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
  ...
  //!  @groupheader{Example}
  //!
  //!  @godbolt_todo{doc/core/is_ngez.cpp}
  //======================================================================================================================
