...
namespace plf
{
  ...
  //!   namespace polyfloat
  //!   {
  //!      template<polyfloat::concepts::polyfloat_like T1, polyfloat_like Z2> constexpr auto is_greater_equal(T1 z1, T2 z2) noexcept;
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
...
namespace plf::_
{
  ...
  POLYFLOAT_FORCEINLINE constexpr auto is_greater_equal_(POLYFLOAT_DELAY(),
                                                         O const&,
                                                         Z1 const& z1,
