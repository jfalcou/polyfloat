...
namespace plf
{
  ...
  template<typename Options> struct maxabs_t : eve::strict_tuple_callable<maxabs_t, Options, raw_option, pedantic_option>
  {
  ...
  constexpr auto neutral(maxabs_t<Options>) noexcept { return plf::valmin; }
}
