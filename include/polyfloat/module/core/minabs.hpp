...
namespace plf
{
  ...
  template<typename Options> struct minabs_t : eve::strict_tuple_callable<minabs_t, Options, raw_option, pedantic_option>
  {
  ...
  constexpr auto neutral(minabs_t<Options>) noexcept { return plf::valmin; }
}
