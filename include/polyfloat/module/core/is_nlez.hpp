...
namespace plf
{
  ...
  struct is_nlez_t : eve::elementwise_callable<is_nlez_t, Options, raw_option, pedantic_option>
  {
  ...
  //!   namespace polyfloat
  //!   {
  //!      template<polyfloat::concepts::polyfloat_like T> constexpr auto is_nlez(T z) noexcept;
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
  ...
  //!  @groupheader{Example}
  //!
  //!  @godbolt_todo{doc/core/is_nlez.cpp}
  //======================================================================================================================
