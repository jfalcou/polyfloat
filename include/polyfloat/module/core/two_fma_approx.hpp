...
namespace plf
{
  ...
  template<typename Options> struct two_fma_approx_t : eve::strict_tuple_callable<two_fma_approx_t, Options, raw_option, pedantic_option>
  {
    ...
    POLYFLOAT_FORCEINLINE typename kumi::tuple<result<T0, T1, T2>,
                                               result<T0, T1, T2>> constexpr operator()(T0 t0, T1 t1, T2 t2) const noexcept
    {
...
//!
//!  @groupheader{Example}
//!  @godbolt{doc/core/core/two_fma_approx.cpp}
//================================================================================================
