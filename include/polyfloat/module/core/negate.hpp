...
namespace plf
{
  ...
  struct negate_t : eve::strict_tuple_callable<negate_t, Options, raw_option, pedantic_option>
  {
  ...
  //!   namespace polyfloat
  //!   {
  //!      template<polyfloat::concepts::polyfloat_like T1, polyfloat_like Z2> constexpr auto negate(T1 z1, T2 z2) noexcept;
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
  ...
  //!  @groupheader{Example}
  //!
  //!  @godbolt_todo{doc/core/negate.cpp}
  //======================================================================================================================
