...
namespace plf
{
  ...
  template<typename Options> struct minmag_t : eve::strict_tuple_callable<minmag_t, Options, raw_option, pedantic_option>
  {
  ...
  constexpr auto neutral(minmag_t<Options>) noexcept { return plf::valmin; }
}
