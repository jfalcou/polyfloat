...
namespace plf
{
  ...
  template<typename Options> struct is_greater_t : eve::strict_tuple_callable<is_greater_t, Options, raw_option, pedantic_option>
  {
    ...
    POLYFLOAT_CALLABLE_OBJECT(is_greater_t, is_greater_);
  };
  //======================================================================================================================
  //! @addtogroup core
  //! @{
  ...
  //!   namespace polyfloat
  //!   {
  //!      template<polyfloat::concepts::polyfloat_like T1, polyfloat_like Z2> constexpr auto is_greater(T1 z1, T2 z2) noexcept;
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
