...
namespace plf
{
  ...
  struct is_infinite_t : eve::elementwise_callable<is_infinite_t, Options, raw_option, pedantic_option>
  {
  ...
  //!   namespace polyfloat
  //!   {
  //!      template<polyfloat::concepts::polyfloat_like T> constexpr auto is_infinite(T z) noexcept;
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
