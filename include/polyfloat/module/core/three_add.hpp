...
namespace plf
{
  ...
  struct three_add_t : eve::strict_tuple_callable<three_add_t, Options, raw_option, pedantic_option>
  {
    ...
    struct result : kumi::tuple<as_polyfloat_like<Ts...>, as_polyfloat_like<Ts...>, as_polyfloat_like<Ts...>>
    ...
    EVE_FORCEINLINE //typename result<Z0, Z1, Z2>::type
      kumi::tuple<Z0, Z0, Z0> constexpr operator()(Z0 z0, Z1 z1, Z2 z2) const noexcept
    {
