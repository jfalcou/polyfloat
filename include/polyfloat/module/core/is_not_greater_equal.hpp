...
namespace plf
{
  ...
  //!   namespace polyfloat
  //!   {
  //!      template<polyfloat::concepts::polyfloat_like T1, polyfloat_like Z2> constexpr auto is_not_greater_equal(T1 z1, T2 z2) noexcept;
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
  ...
  //!  @groupheader{Example}
  //!
  //!  @godbolt_todo{doc/core/is_not_greater_equal.cpp}
  //======================================================================================================================
...
namespace plf::_
{
  ...
  POLYFLOAT_FORCEINLINE constexpr auto is_not_greater_equal_(POLYFLOAT_DELAY(), O const& , Z1 const& z1, Z2 const& z2) noexcept
  {
