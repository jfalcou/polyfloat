...
namespace plf
{
  ...
  struct dekker_prod_t : eve::strict_tuple_callable<dekker_prod_t, Options, raw_option, pedantic_option>
  {
  ...
  namespace _
  {
    ...
    constexpr POLYFLOAT_FORCEINLINE auto dekker_prod_(POLYFLOAT_DELAY(), O const&, T0 aa, T1 bb) noexcept
    {
