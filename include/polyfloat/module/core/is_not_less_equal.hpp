...
namespace plf
{
  ...
  template<typename Options> struct is_not_less_equal_t : eve::strict_tuple_callable<is_not_less_equal_t, Options, raw_option, pedantic_option>
  {
    ...
    POLYFLOAT_CALLABLE_OBJECT(is_not_less_equal_t, is_not_less_equal_);
  };
  //======================================================================================================================
  //! @addtogroup core
  //! @{
...
namespace plf::_
{
  ...
  POLYFLOAT_FORCEINLINE constexpr auto is_not_less_equal_(POLYFLOAT_DELAY(), O const& , Z1 const& z1, Z2 const& z2) noexcept
  {
    using r_t = as_polyfloat_t<Z1, Z2>;
    if constexpr(dimension_v<r_t> == 1)
      return eve::is_not_less_equal(z1, z2);
    else
    {
