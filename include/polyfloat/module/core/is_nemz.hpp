...
namespace plf
{
  ...
  template<typename Options> struct is_nemz_t : eve::elementwise_callable<is_nemz_t, Options, raw_option, pedantic_option>
  {
  ...
  //!   namespace kyosu
  //!   {
  //!      template<kyosu::concepts::polyfloat_like T> constexpr auto is_nemz(T z) noexcept;
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
