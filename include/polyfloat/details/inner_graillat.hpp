...
namespace plf::_
{
  template<typename T> constexpr auto is_n_1or3_t_p2(T x) noexcept // Graillat & Muller algorithm 5
  {
  ...
  // https://hal.science/hal-04575249
  {
    ...
    auto z = eve::if_else(in, wh, sh + eve::if_else(samsgn, c9_8, c7_8) * vh);
