...
namespace plf
{
  ...
  template<typename Options> struct is_pow2_t : eve::elementwise_callable<is_pow2_t, Options, raw_option, pedantic_option>
  {
  ...
  //!   namespace kyosu
  //!   {
  //!      template<kyosu::concepts::polyfloat_like T> constexpr auto is_pow2(T z) noexcept;
  //!   }
  //!   @endcode
  //!
  //!   **Parameters**
