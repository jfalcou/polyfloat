  ...
  <typename T>(tts::type<T>)
{
  ...
  using wT     = eve::wide<T>;
  std::cout << "type of pf3_t element is " <<   tts::typename_<eve::element_type_t<pf3_t>> << std::endl;
  std::cout << "type of pf3_t element is " <<   tts::typename_<eve::element_type_t<pf2_t>> << std::endl;
